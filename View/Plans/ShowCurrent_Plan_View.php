...
class ShowCurrent_Plan extends Header {
    var $build_plan;
    var $building;
    var $plan;
    var $definitions;
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <ul>
                                        ...
                                        <?php endif; ?>
                                        <?php if($this->build_plan['fecha_vencimiento'] != default_data): ?>
                                        <li>
                                            <i class="bx bx-chevron-right att-icon"></i><span class="att-field i18n-date_expire">Fecha Vencimiento</span>
                                            <span class="d-block att-value"><?php echo date_format(date_create($this->build_plan['fecha_vencimiento']), 'd/m/Y') ?></span>
                                        </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
