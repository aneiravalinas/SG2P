            ...
            <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 text-center">
                        ...
                        <h2 class="mb-4 i18n-def-sims">Definiciones de Simulacros</h2>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 table-responsive" id="col-table">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th scope="col" class="i18n-simulacro_id text-center">ID Simulacro</th>
                                <th scope="col" class="i18n-nombre text-center">Nombre</th>
                                <th scope="col"></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($this->sims as $sim): ?>
                                <tr>
                                    <td class="text-center align-middle"><?php echo $sim['simulacro_id'] ?></td>
                                    <td class="text-center align-middle"><?php echo $sim['nombre'] ?></td>
                            ...
                            <?php endforeach; ?>
                            <?php if(empty($this->sims)) :?>
                                <tr>
                                    <td colspan="3" class="text-center">
                                        <span class="i18n-def-sims-empty">No hay definiciones de simulacros registradas</span>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
