...
class ShowCurrent_Procedure extends Header {
    var $imp_proc;
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <ul>
                                        ...
                                        <?php if($this->imp_proc['fecha_vencimiento'] != default_data) :?>
                                            <li>
                                                <i class="bx bx-chevron-right att-icon"></i><span class="att-field i18n-date_expire">Fecha Vencimiento</span>
                                                <span class="d-block att-value"><?php echo date_format(date_create($this->imp_proc['fecha_vencimiento']),'d/m/Y');?></span>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
