            ...
            <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 text-center">
                        ...
                        <h2 class="mb-4 i18n-add-defProc">Definir Procedimiento</h2>
                    </div>
                        ...
                        <form name="formularioadd" method="post">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" onblur="check_NOMBRE_DEFPROC();"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="5" onblur="check_DESCRIPCION_DEFPROC();"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between flex-wrap">
                                    ...
                                    <a class="btn-get-started i18n-enviar" type="button" onclick="
                                        ...
                                        insertacampo(document.formularioadd,'controller','DefProc');
                                        insertacampo(document.formularioadd,'action','add');
                                        enviaformcorrecto(document.formularioadd,check_DEFPROC());">
                                        Enviar
                                    </a>
                                </div>
                            </div>
