            ...
            <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 text-center">
                        ...
                        <h2 class="mb-4 i18n-search-defProc">Buscar Def. de Procedimientos</h2>
                    </div>
                        ...
                        <form name="formulariosearch" method="post">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="procedimiento_id" name="procedimiento_id" onblur="check_DEFPROC_ID_SEARCH();"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" onblur="check_NOMBRE_DEFPROC_SEARCH();"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between flex-wrap">
                                    ...
                                    <a class="btn-get-started i18n-enviar" type="button" onclick="
                                        ...
                                        insertacampo(document.formulariosearch,'controller','DefProc');
                                        insertacampo(document.formulariosearch,'action','show');
                                        enviaformcorrecto(document.formulariosearch,check_DEFPROC_SEARCH());">
                                        Enviar
                                    </a>
                                </div>
                            </div>
