            ...
            <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 text-center">
                        <h1 class="i18n-current-defProc pt-5 pb-5 mt-5">Detalles de la def. del Procedimiento</h1>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="col-5 d-flex justify-content-center">
                                    <ul>
                                        <li>
                                            ...
                                            <span class="d-block att-value"><?php echo $this->proc['plan_id'] ?></span>
                                        </li>
                                        <li>
                                            <i class="bx bx-chevron-right att-icon"></i><span class="att-field i18n-procedimiento_id">ID Procedimiento</span>
                                            <span class="d-block att-value"><?php echo $this->proc['procedimiento_id'] ?></span>
                                        </li>
                                        <li>
                                            <i class="bx bx-chevron-right att-icon"></i><span class="att-field i18n-nombre">Nombre</span>
                                            <span class="d-block att-value"><?php echo $this->proc['nombre'] ?></span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-7 d-flex justify-content-center">
                                    <ul>
                                        <li>
                                            ...
                                            <span class="d-block att-value"><?php echo $this->proc['descripcion'] ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
