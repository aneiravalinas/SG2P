                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 table-responsive" id="col-table">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th scope="col" class="i18n-procedimiento_id text-center">ID Procedimiento</th>
                            ...
                            <?php foreach($this->procs as $proc): ?>
                                <tr>
                                    <td class="text-center align-middle"><?php echo $proc['procedimiento_id'] ?></td>
                                    <td class="text-center align-middle"><?php echo $proc['nombre'] ?></td>
