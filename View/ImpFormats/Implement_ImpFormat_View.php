                        ...
                        <form name="formularioadd" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="edificio_formacion_id" class="i18n-cump_id">ID Cumplimentación</label>
                                    <input type="text" value="<?php echo $this->imp_format['edificio_formacion_id'] ?>" class="form-control" id="edificio_formacion_id" name="edificio_formacion_id" readonly/>
                                </div>
                                <div class="form-group col-md-4">
