...
class ShowCurrent_ImpFormat extends Header {
    var $imp_format;
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row content justify-content-center">
                        <div class="col-xl-7 col-lg-8">
                            <div class="row">
                                <div class="col-5 d-flex justify-content-cente">
                                    <ul>
                                        <li>
                                ...
                                <div class="col-7 d-flex justify-content-center">
                                    <ul>
                                        ...
                                        <?php endif; ?>
                                        <?php if($this->imp_format['fecha_cumplimentacion'] != default_data) :?>
                                            <li>
                                                <i class="bx bx-chevron-right att-icon"></i><span class="att-field i18n-date_comp">Fecha Cumplimentación</span>
                                                <span class="d-block att-value"><?php echo date_format(date_create($this->imp_format['fecha_cumplimentacion']),'d/m/Y');?></span>
                                            </li>
                                        <?php endif; ?>
