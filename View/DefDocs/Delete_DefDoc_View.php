...
class Delete_DefDoc extends Header {
    var $doc;
    ...
    function render() {
        ...
        <section id="hero" class="d-flex align-items-center">
            <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 text-center">
                        <h3 class="mb-4 i18n-del-def-doc-confirm">¿Está seguro que desea eliminar la definición de este documento? El cambio no será reversible</h3>
                        <h2><?php echo $this->doc['documento_id'] ?> - <?php echo $this->doc['nombre'] ?></h2>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-9 d-flex justify-content-between flex-wrap">
                        ...
                        <a id="btn-cancel" type="button" class="btn-get-started i18n-delete" onclick="
                            crearform('formenviar','post');
                            insertacampo(document.formenviar, 'documento_id', '<?php echo $this->doc['documento_id'] ?>');
