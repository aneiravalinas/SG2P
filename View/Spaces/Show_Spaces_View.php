                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-9 table-responsive" id="col-table">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th scope="col" class="i18n-espacio_id text-center">ID Espacio</th>
                            ...
                            <?php foreach($this->spaces as $space): ?>
                                <tr>
                                    <td class="text-center align-middle"><?php echo $space['espacio_id'] ?></td>
                                    <td class="text-center align-middle"><?php echo $space['nombre'] ?></td>
